...
(function (MusuprApp) {
    var SecurityService = (function () {
        ...
        SecurityService.prototype.GetSHA512 = function (text) {
            var str = text;
    ...
    MusuprApp.SecurityService = SecurityService;
})(MusuprApp || (MusuprApp = {}));
angular.module('MusuprApp').service('SecurityService', MusuprApp.SecurityService);
