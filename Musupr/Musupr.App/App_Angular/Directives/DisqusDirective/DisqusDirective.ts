module MusuprApp {
    declare var disqus_url;
    declare var disqus_identifier;
    declare var disqus_title;

    angular.module('MusuprApp').directive('disqus', ['$window', function ($window: ng.IWindowService) {
        return {
            restrict: 'E',
            transclude: true,
            scope: {
