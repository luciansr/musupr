...
angular.module('MusuprApp').config([
    '$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        var resolveAuthentication = function (allowedRoles) {
            var authObj = {
                auth: [
                    "$q", "AccountService", function ($q, AccountService) {
...
angular.module('MusuprApp').config([
    '$httpProvider', '$analyticsProvider', 'usSpinnerConfigProvider', function ($httpProvider, $analyticsProvider, usSpinnerConfigProvider) {
