...
(function (MusuprApp) {
    angular.module('MusuprApp').controller('MeusAnunciosController', ['UsuarioService', 'LogService', '$location', 'AccountService', 'AdminService', 'VagasService',
        function (UsuarioService, LogService, $location, AccountService, AdminService, VagasService) {
            var self = this;
            self.items = {
                vagas: []
            };
            ...
            self.DesbloquearAnuncio = function (id) {
                AdminService.DesbloquearAnuncio(id).then(function (data) {
            ...
            self.BloquearAnuncio = function (id) {
                AdminService.BloquearAnuncio(id).then(function (data) {
            ...
            self.DesbloquearUsuario = function (id) {
                AdminService.DesbloquearUsuario(id).then(function (data) {
            ...
            self.BloquearUsuario = function (id) {
                AdminService.BloquearUsuario(id).then(function (data) {
            ...
            self.ExpirarAnuncio = function (id) {
                VagasService.ExpirarAnuncio(id).then(function (data) {
            ...
            loadItems();
            function loadItems() {
                UsuarioService.GetItensDoUsuario().then(function (data) {
...
//# sourceMappingURL=MeusAnunciosController.js.map