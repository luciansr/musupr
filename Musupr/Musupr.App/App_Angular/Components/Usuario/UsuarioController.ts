module MusuprApp {
    angular.module('MusuprApp').controller('UsuarioController', ['UsuarioService', '$routeParams', 'LogService', '$location', 'vcRecaptchaService', 'AccountService',
        function (UsuarioService: UsuarioService, $routeParams, LogService: LogService, $location, vcRecaptchaService, AccountService: AccountService) {
            var self = this;
            ...
            self.EditaUsuario = function () {
                ...
                UsuarioService.EditaUsuario(self.usuario, reCaptchaResponse).then(
                    function (data) {
            ...
            init();
            function init() {
                UsuarioService.GetUsuarioByID($routeParams.id).then(
                    function (data: any) {
                        self.usuario = data;
                    },
                    function (error) {
