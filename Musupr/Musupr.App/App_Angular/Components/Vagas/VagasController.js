var MusuprApp;
(function (MusuprApp) {
    angular.module('MusuprApp').controller('VagasController', [
        'VagasService', '$scope', '$routeParams', '$location',
        function (VagasService, $scope, $routeParams, $location) {
            var self = this;
            self.selectedPage = 1;
            ...
            self.temDados = function () {
                return !self.naoTemDados();
            };
            ...
            function init() {
                ...
                VagasService.GetDadosDeVagaPorRecomendacao(self.selectedPage, $routeParams.busca).then(function (data) {
