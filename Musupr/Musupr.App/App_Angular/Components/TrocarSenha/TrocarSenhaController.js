...
(function (MusuprApp) {
    angular.module('MusuprApp').controller('TrocarSenhaController', ['$routeParams', 'LogService', '$location', 'vcRecaptchaService', 'AccountService',
        function ($routeParams, LogService, $location, vcRecaptchaService, AccountService) {
            var self = this;
            ...
            self.trocarSenha = function () {
                ...
                AccountService.TrocarSenha(self.guid, self.userID, self.password, reCaptchaResponse).then(function (data) {
...
//# sourceMappingURL=TrocarSenhaController.js.map